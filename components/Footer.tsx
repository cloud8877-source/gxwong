      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-stone-400 max-w-xs">{t.footer.tagline}</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">{t.footer.navigation}</h3>
            <ul className="space-y-2">
              {t.navLinks.map(link => (
                 <li key={link.label}><a href={link.href} className="text-stone-400 hover:text-amber-300 transition-colors">{link.label}</a></li>
              ))}
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-stone-400">
              <li><a href="mailto:cloud8877@gmail.com" className="hover:text-amber-300">cloud8877@gmail.com</a></li>
              <li><a href="tel:+60108828127" className="hover:text-amber-300">+60 10-8828127</a></li>
        ...
        <div className="mt-12 border-t border-green-800 pt-6 text-center text-stone-500">
